...
<jsp:useBean id="respaldoIndex" scope="request" class="com.daw.principalservidor2daw.respaldos.RespaldoIndex"/>
...
<html>
    <head>
        ...
        <link rel="icon" href="img/imagenDaw.png">
            ...
            $(document).ready(function () {
                ...
                $(document).ready(function () {
                    $('.accordion-button').click(function () {
                        ...
                        $('.accordion-collapse').not($(this).next()).collapse('hide');
                    });
                });
    ...
    <body>
        <header>
            <nav class="navbar bg-body-tertiary">
                <div class="container-fluid text-white">
                    ...
                    <a  href="http://aplicaciones-martinrivero.ddns.net:8081/AccesoServidor2daw" role="button" class="text-white text-decoration-none" title="Ir a acceso servidor"  aria-label="Ir a acceso servidor">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                        <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
                        <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z"/>
                        </svg><span id="spanAdmin" class="ms-2 fs-4">Administrar</span>
                    </a>    
                    <!--
                <div id="divLogin">
        ...
        <main >
            ...
            <h1 class="text-center mt-3" id="tituloP">Proyectos </h1>
            <!--
            ...
            <div class="d-flex g-0 justify-content-evenly row-cols-lg-2 p-2 p-lg-4  flex-wrap">
                <c:forEach items="${respaldoIndex.listaProyectos}" var="proyecto">    
                    <div class="accordion col-12 col-md-6 col-lg-5 mt-5" id="proyecto${proyecto.codProyecto}">
                        <div class="accordion-item">
                            ...
                            <div id="collapse${proyecto.codProyecto}" class="accordion-collapse collapse" aria-labelledby="heading${proyecto.codProyecto}"
                                ...
                                <div class="accordion-body d-flex flex-column align-items-center">
                                    ...
                                    <p>Fecha de creación: <fmt:formatDate value="${proyecto.fecha}" pattern="dd/MM/yyyy"/></p>
